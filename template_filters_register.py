from template_filters import (album_position_style, calc_floor,
                              ...
                              format_datetime, get_blog_label,
                              get_displayed_page_nums,
                              get_photo_comment_media_list, get_photo_url,
                              get_shuoshuo_media_list, get_uin_avatar_url,
                              is_blog_reprinted, matched_comments,
                              photo_position_style, purge_file,
                              shuoshuo_media_class, shuoshuo_media_size)
...
def register_filters(app):
    ...
    app.jinja_env.filters["get_blog_label"] = get_blog_label
    ...
    app.jinja_env.filters["is_blog_reprinted"] = is_blog_reprinted
